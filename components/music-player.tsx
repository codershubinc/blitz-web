            ...
            <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                    ...
                    {playerName?.toLowerCase() === 'spotify' && (
                        <div className="flex-shrink-0" title="Spotify">
                ...
                <div className="flex items-center gap-6 mb-6">
                    {showSkeleton ? (
                        <>
                            <Skeleton className="w-40 h-40 rounded-2xl bg-linear-to-br from-white/10 to-white/5 flex-shrink-0" />
                            ...
                            {albumArtVisible && (
                                <div className="relative group/art shrink-0">
                                    ...
                                    <img
                                        src={albumArt}
                                        alt="Album artwork"
                                        className={`relative w-60 h-60 rounded-2xl object-cover shadow-2xl transition-all duration-500 group-hover/art:scale-105 ${albumArtFading ? 'opacity-0' : 'opacity-100'
                                            }`}
                                    />
                                </div>
                            )}
