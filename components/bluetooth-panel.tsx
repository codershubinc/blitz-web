                ...
                <div className="flex flex-col gap-3">
                    {devices.length === 0 ? (
                        ...
                        devices.map((device, idx) => (
                            <div
                                key={idx}
                                className="relative group/device bg-gradient-to-r from-[#0a0e27]/60 to-[#1a1d3a]/60 p-4 rounded-xl flex justify-between items-center hover:from-[#1a1d3a]/80 hover:to-[#0a0e27]/80 hover:shadow-[0_4px_16px_rgba(99,102,241,0.3)] transition-all duration-300 border border-white/5 backdrop-blur-sm"
                            >
