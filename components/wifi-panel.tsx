...
export function WiFiPanel({ info }: WiFiPanelProps) {
    return (
        <Card className="relative p-6 bg-linear-to-br from-[#1a1d3a]/80 via-[#0f1223]/80 to-[#1a1d3a]/80 border-2 border-[#6366f1]/30 backdrop-blur-xl shadow-[0_8px_32px_rgba(99,102,241,0.15)] overflow-hidden h-full">
            <div className="absolute inset-0 bg-linear-to-br from-[#6366f1]/5 via-transparent to-[#6366f1]/5 pointer-events-none" />
            <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-[#6366f1] via-[#8b5cf6] to-[#6366f1] opacity-50" />
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex-1">
                                <div className="h-2 bg-black/40 rounded-full overflow-hidden border border-white/10">
                                    <div className="h-full bg-linear-to-r from-[#6366f1] to-[#4f46e5] rounded-full" style={{ width: `${info.signalStrength}%` }} />
                                </div>
